...
build {
  ...
  provisioner "shell" {
    inline = ["while [ ! -f /var/lib/cloud/instance/boot-finished ]; do echo 'Waiting for cloud-init...'; sleep 1; done",
              ...
              "    neofetch",
              "else",
              "    echo \"[INFO] neofetch is not installed. Run 'sudo apt install neofetch' to enable MOTD visuals.\"",
              "fi",
              "",
              ...
              "======================================================================",
              "",
              " Hello, $(logname)! 👋  Welcome to your virtual machine.",
              "",
              " This VM is provisioned by AlexDiasHomelab and is part of a managed",
              " infrastructure optimized for:",
              "   • Lab experimentation",
              "   • Development & testing",
              "   • Secure and monitored deployments",
              "",
              " ⚠️  Unauthorized access or configuration changes outside lab scope",
              "     may result in environment resets.",
              "",
              " 📅  VM Provision Date: $(uptime -s)",
